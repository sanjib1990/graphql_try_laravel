...
@foreach($a as $i)
    <h1>{!! $i !!}</h1>
@endforeach
<div class="razorpay-embed-btn" data-url="https://pages.razorpay.com/pl_HIqH7y36yBZAfi/view" data-text="Pay Now"
     data-color="#528FF0" data-size="medium">
    <script>
        (function () {
            var d = document;
...
<div>
    <div class="razorpay-embed-btn" data-url="https://pages.razorpay.com/pl_HIrRWNTk0lIDGy/view"
         data-text="Item Payment" data-color="#528FF0" data-size="large">
        <script>
            (function () {
                var d = document;
                var x = !d.getElementById('razorpay-embed-btn-js')
